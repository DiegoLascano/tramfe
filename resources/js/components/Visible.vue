8<template>
    <transition name="fade">
        <div v-show="show" class="z-0">
            <a href="#" class="fixed right-0 bottom-0">
                <inline-svg name="icon-cheveron-up-circle-new" classes="h-10 w-10 md:h-12 md:w-12 mr-6 mb-6 md:mr-12 md:mb-12"></inline-svg>
            </a>
        </div>
    </transition>
</template>
